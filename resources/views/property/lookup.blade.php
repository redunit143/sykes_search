    ...
    <body class="antialiased">
        <div id="search-container" class="">
            <form method="POST" action="search">
                <p>
                    <label>Location</label></label><input type="input" name="location" value="{{ old('location') ? old('location') : request('location') }}">
                    @error('location')
                ...
                <p>
                    <label>Accepts Pets</label> <input name="accepts_pets" type="checkbox" value="1" {{ ((old('accepts_pets') ? old('accepts_pets') : request('accepts_pets')) == 1 ? 'checked="checked"' : '') }}>
                    @error('accepts_pets')
                        <span class="alert alert-danger">{{ $errors->first('accepts_pets') }}</span>
                    @enderror
                </p>
                <p>
                    <label>Sleeps</label></label><input type="input" name="sleeps" value="{{ old('sleeps') ? old('sleeps') : request('sleeps') }}">
                    @error('sleeps')
