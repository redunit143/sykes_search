        ...
        <div id="search-container" class="">
            <form method="POST">
                <div class="form-group">
                    <label>Location</label></label><input type="input" name="location" />
                    @error('location')
                        <span class="alert alert-danger">{{ $errors->first('location') }}</span>
                    @enderror
                </div>
                <p>
                    <label>Near the Beach</label> <input name="near_beach" type="checkbox" value="1" />
                    @error('near_beach')
                        <span class="alert alert-danger">{{ $errors->first('near_beach') }}</span>
                    @enderror
                </p>
                <p>
                    <label>Accepts Pets</label> <input name="accepts_pets" type="checkbox" value="1" />
                    @error('accepts_pets')
                        <span class="alert alert-danger">{{ $errors->first('accepts_pets') }}</span>
                    @enderror
                </p>
                <p>
                    <label>Sleeps</label></label><input type="input" name="sleeps" value="">
                    @error('sleeps')
                        <span class="alert alert-danger">{{ $errors->first('sleeps') }}</span>
                    @enderror
                </p>
                <p>
                    <label>Beds</label></label><input type="input" name="beds" value="{{ old('beds') ? old('beds') : request('beds') }}" />
                    @error('beds')
                ...
                <p>
                    ...
                    <div class='input-group date'>
                        <input type='text' class="form-control" name="start_date" placeholder="YYYY-MM-DD" id='startdate' autocomplete="off" />
                ...
                <p>
                    ...
                    <div class='input-group date'>
                        <input type='text' class="form-control" name="end_date" placeholder="YYYY-MM-DD" id='enddate' autocomplete="off" />
                        <span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                    </div>
